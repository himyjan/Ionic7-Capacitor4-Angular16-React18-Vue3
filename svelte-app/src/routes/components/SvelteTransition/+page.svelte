...
<IonPage>
	...
	<ion-content fullscreen class="ion-padding">
		...
		{#if visible}
			<p transition:fade|global>Fades in and out</p>

			<p transition:fly|global={{ y: 2000, duration: 2000 }}>Flies in and out</p>

			<p in:fly|global={{ y: 200, duration: 2000 }} out:fade|global>Flies in, fades out</p>

			<div class="centered" in:spin|global={{ duration: 8000 }} out:fade|global>
				<div class="span">transitions!</div>
			</div>

			<p transition:typewriter|global>The quick brown fox jumps over the lazy dog</p>
		...
		<div>
			<h2>
				...
				{#key number}
					<span style="display: inline-block" in:fly|global={{ y: -20 }}>
						{number}
					</span>
				{/key}
			</h2>
